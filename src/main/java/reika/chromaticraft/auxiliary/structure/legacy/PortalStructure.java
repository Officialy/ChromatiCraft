/*
 * PRISTINE V33a REFERENCE - DO NOT COMPILE, DO NOT MODIFY.
 *
 * This is Reika's original 1.7.10 PortalStructure, kept verbatim as the single geometry authority for
 * chromaticraft:multiblock/portal. ChromaStructureTemplateProvider.importPortal() parses its 581
 * placement calls into the canonical structure NBT, exactly as the failed-casting village, cavern,
 * burrow, ocean, desert and snow templates are imported from their own untouched sources.
 *
 * The compiled, modern PortalStructure lives one package up and is NBT-backed. This file is outside
 * the build.gradle allowlist and is 1.7.10 code; it will not compile and is not meant to.
 */
package reika.chromaticraft.auxiliary.structure.legacy;
